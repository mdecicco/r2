...
float getScroll();
float getDragOffsetX(unsigned char idx);
float getDragOffsetY(unsigned char idx);
float getDragDeltaX(unsigned char idx);
float getDragDeltaY(unsigned char idx);