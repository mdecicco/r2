class ObjFile {
	...
	makeNode(vfmt, ifmt, instances) {
		...
		// todo:
		// make this call unnecessary, since instances can be controlled by entity scripts
		// the internal instance buffer doesn't need to be populated at this stage unless instances
		// are static
